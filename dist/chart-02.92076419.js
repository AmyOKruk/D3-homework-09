...
var xPositionScale = d3.scaleLinear().domain([2000, 2010]).range([0, width]);
var yPositionScale = d3.scaleLinear().domain([0, 16]).range([height, 0]); // Create a d3.line function
...
.range(['red', 'orange', 'yellow', 'green', 'blue', 'purple']); // Import your data file
...
function ready(datapoints) {
  ...
  svg.selectAll('path').data(nested).enter().append('path').attr('fill', 'none').attr('stroke', 'black').attr('d', function (d) {
