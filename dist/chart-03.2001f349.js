...
var svg = d3.select('#chart-03').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')'); // Create our scales
...
var colorScale = d3.scaleOrdinal().range(['#e41a1c', '#377eb8', '#4daf4a', '#984ea3']);
...
function ready(datapoints) {
  ...
  }).attr('opacity', 0.8).attr('d', function (d) {
    console.log('this nested thing is', d); // Takes all of the datapoints in that
